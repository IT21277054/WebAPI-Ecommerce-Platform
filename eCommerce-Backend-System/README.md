...
To update the database use this command from the Web project folder (replace `eCommerce_Backend_System` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../eCommerce_Backend_System.Infrastructure/eCommerce_Backend_System.Infrastructure.csproj -s eCommerce_Backend_System.Web.csproj
```
